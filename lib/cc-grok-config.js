...
function readConfig(configPath) {
  ...
  return {
    ...
    contextWindows: {
      ...
      ...(parsed.contextWindows && typeof parsed.contextWindows === "object" && !Array.isArray(parsed.contextWindows)
...
console.log(`export CC_GROK_CONTEXT_WINDOWS=${shellQuote(JSON.stringify(config.contextWindows))}`);
